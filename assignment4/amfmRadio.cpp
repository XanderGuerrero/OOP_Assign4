...
bool AmFmRadio::SetCurrentStation( double newCurrentStation )
{
	...
	if ((newCurrentStation >= 530) && (newCurrentStation <= 1700))// Checking if new station is within range
	{
...
//FunctionName:AmFmRadio::SetRadioOnOFF(bool radio_On)
//Parameters:	(bool radio_On)
//Description:	Sets the radio value to true or false
//returns:		bool radio_On
bool AmFmRadio::SetRadioOnOFF(bool radio_On)
{
	radio_On = radio_On;
